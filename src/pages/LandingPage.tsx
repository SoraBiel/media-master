        ...
        <div className="container mx-auto px-4 relative">
          ...
          >
            <div className="relative">
              ...
              <motion.div 
                className="absolute top-1/3 left-1/2 -translate-x-1/2 w-[60%] h-[40%] bg-cyan-400/15 blur-[80px] rounded-full"
                    ...
                    <div className="flex min-h-[320px] sm:min-h-[380px]">
                      ...
                      <div className="flex-1 bg-[#0d1117] p-4 sm:p-5 overflow-hidden">
                        ...
                        <div className="grid grid-cols-3 gap-2 sm:gap-3 mb-4 sm:mb-5">
                          {[
                            { icon: Users, color: "text-cyan-400", bg: "bg-cyan-500/10", value: "247", label: "Leads no Período" },
                            { icon: Target, color: "text-emerald-400", bg: "bg-emerald-500/10", value: "8", label: "Funis Ativos" },
                            { icon: DollarSign, color: "text-emerald-400", bg: "bg-emerald-500/10", value: "R$ 12.450", label: "Faturamento" },
                          ].map((stat, i) => (
                            <motion.div
                              key={i}
                        ...
                        >
                          ...
                          <div className="h-[80px] sm:h-[100px] flex items-end justify-between gap-1 px-1">
                            {[35, 52, 41, 68, 45, 89, 72].map((height, i) => (
                              <motion.div
                                key={i}
                                initial={{ height: 0 }}
                                animate={{ height: `${height}%` }}
                                transition={{ delay: 2.1 + i * 0.08, duration: 0.6, ease: "easeOut" }}
                        ...
                        >
                          ...
                          <div className="divide-y divide-[#21262d]/50">
                            {[
                              { name: "Vendas VIP", bot: "@vip_bot", leads: "89/67", conv: 75, active: true },
                              { name: "Captura Lead", bot: "@lead_bot", leads: "156/112", conv: 72, active: true },
                              { name: "Remarketing", bot: "@rmkt_bot", leads: "45/38", conv: 84, active: false },
                            ].map((row, i) => (
                              <motion.div 
                                key={i}
                              ...
                              >
                                ...
                                <div className="flex justify-center">
                                  <span className={`px-1.5 py-0.5 rounded text-[7px] sm:text-[9px] font-bold ${
                                    row.conv >= 75 ? 'bg-emerald-500/20 text-emerald-400' : 'bg-amber-500/20 text-amber-400'
                                  }`}>
                                    {row.conv}%
                                  </span>
                                </div>
                                <div className="flex justify-center">
                                  <span className={`flex items-center gap-1 text-[7px] sm:text-[9px] font-medium px-1.5 py-0.5 rounded ${
                                    row.active 
